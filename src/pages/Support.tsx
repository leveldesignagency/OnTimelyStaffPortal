  ...
  return (
    <div className="p-8 bg-gray-50 dark:bg-gray-950 min-h-screen">
      ...
      <div className="mb-10">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">Support & Help</h1>
          <p className="text-gray-600 dark:text-gray-400 text-lg">Manage support tickets and provide user assistance</p>
        </div>
                ...
                <tr key={ticket.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-gray-900 dark:text-gray-100">{ticket.user}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Knowledge Base</h3>
